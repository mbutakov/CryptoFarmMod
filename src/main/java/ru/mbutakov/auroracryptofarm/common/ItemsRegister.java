...
public class ItemsRegister {
	...
	public static void registerItems() {
		...
		item_cpu_1gx = new CpuItem("Aurora Core 1gx","core1gx",Main.cryptoTab,0.1f,250,300);
		...
		item_motherboard_s100 = new MotherboardItem("Aurora Motherboard s100","motherboardz10",Main.cryptoTab,1240,1,EnumFormatMotherboard.MicroATX);
		item_motherboard_s200 = new MotherboardItem("Aurora Motherboard s200","motherboardz10",Main.cryptoTab,1240,2,EnumFormatMotherboard.MicroATX);
		item_motherboard_s300 = new MotherboardItem("Aurora Motherboard s300","motherboardz10",Main.cryptoTab,1240,3,EnumFormatMotherboard.MicroATX);
