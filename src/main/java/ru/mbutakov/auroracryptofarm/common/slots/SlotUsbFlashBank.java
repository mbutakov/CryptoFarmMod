...
public class SlotUsbFlashBank extends Slot {
	
	private ContainerBlockBank container;
	
	public SlotUsbFlashBank(IInventory inventory, int i, int x, int y, ContainerBlockBank s) {
